...
namespace Manus
{
    public partial class CoreSDK
    {
        ...
        public enum SDKReturnCode
        {
            ...
            StubNullPointer = 18,
            /// <summary>Skeleton could not be loaded. usually when using more then the max skeletons per session (16).</summary>
        ...
        public const int SKELETONLANDSCAPE_SKELETONS_ARRAY_SIZE = 16;
        ...
        public struct SettingsLandscape
        {
            ...
            public SettingsLandscape(Version p_ManusCoreVersion,LicenseInfo p_License,bool p_PlaybackMode,bool p_IgnoreSessionTimeOuts,FirmwareVersion p_FirmwareOne,FirmwareVersion p_FirmwareTwo,bool p_RecordingMode)
            {
                manusCoreVersion = p_ManusCoreVersion;
                license = p_License;
        ...
        public struct TimeLandscape
        {
            ...
            public TimeLandscape(TimecodeInterface[] p_Interfaces,uint p_InterfaceCount,TimecodeInterface p_CurrentInterface,TimecodeFPS p_Fps,bool p_FakeTimecode,bool p_UseSyncPulse,bool p_DeviceKeepAlive,bool p_SyncStatus,bool p_TimecodeStatus)
            {
        ...
        public struct Landscape
        {
            ...
            public Landscape(DeviceLandscape p_GloveDevices,UserLandscape p_Users,SkeletonLandscape p_Skeletons,TrackerLandscape p_Trackers,SettingsLandscape p_Settings,TimeLandscape p_Time,uint p_GestureCount)
            {
        ...
        public const int TEMPORARYSKELETONSINFOFORSESSION_SKELETONINFO_ARRAY_SIZE = 16;
